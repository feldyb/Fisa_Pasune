...
function newFisa() {
  currentFisa = {
    ...
    lucrari:[], data: new Date().toLocaleDateString('ro-RO')
  };
  currentFisaIdx = null;
...
function saveFisa() {
  ...
  const fields = ['trPas','ua','sup','grFunct','ts','catFolos','unitRel','confTeren',
    ...
    'arbusti','grAcop','raspArb','vegFor','varsta','consist','raspFor','dateCompl','lucrExec','lucrExecCod',
    'gramTotal','legTotal','divTotal','toxicTotal'];
