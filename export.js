    ...
    if (f.catFolos === 'Pășune împădurită') {
      ...
      function piH(text, w) {
        return new TableCell({ borders:brdP, width:{size:w,type:WidthType.DXA},
          margins:psm, verticalAlign:VerticalAlign.CENTER,
      ...
      function row4(l1,v1,l2,v2) {
        return new TableRow({height:{value:400,rule:'exact'}, children:[
          new TableCell({borders:brdP,width:{size:c4f[0],type:WidthType.DXA},margins:psm,
          ...
          new TableCell({borders:brdP,width:{size:c4f[2],type:WidthType.DXA},margins:psm,
      ...
      piRows.push(row4('Dist. Drum auto (m):', f.piDistDrum, 'Semințiș util.:', f.piSemintis));
